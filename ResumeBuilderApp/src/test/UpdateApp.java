...
public class UpdateApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DBCollection collection = db.getCollection("colll");
			...
			updateDocument.append("$set", new BasicDBObject().append("clients", 1010));

			BasicDBObject searchQuery2 = new BasicDBObject().append("hosting", "hostC");
